...
{!!Form::open(['route'=>['planes-de-tratamientos.update', $plan], 'method' =>'PUT', 'id'=>'tratamientos_update' ,'name'=>'tratamientos_update'])!!}
    ...
    <div>
     <table class="table table-bordered table-hover dataTable" id="tabla-plan">
       ...
       <tbody id='tbody-plan'>
        @if($plan_detalle)
         ...
         <tr>
           ...
           <td>{{$aux->tratamiento->tra_costo}}</td>
           ...
           <td><button id="remove" name="remove" class="btn btn-danger pull-right" type="button" title ="Remover tratamientos"><i class="fa fa-times" aria-hidden="true"></i></button></td>
         </tr>
         @endforeach
         @endif
       </tbody>
       <tfoot>
        ...
        <td> {!!Form::number('pdt_costo_total', $plan->pdt_costo_total, ['class'=>'form-control', "readonly" =>"readonly", "id" => "costo_total"])!!}</td>
        <td></td>
       </tfoot>
     </table>
    </div>
...
<div class="box box-primary">
  <div class="box-body">
    ...
    <div class="col-lg-6" >
        ...
        {!! Form::select('usu_id', $odontologos, $plan->usu_id, ['class' => 'form-control', 'placeholder'=> 'Seleccione..', 'id ' => 'usu_id']) !!}
    </div>
    @else
    <div class="col-lg-6" >
        {!! Form::Label('usu_id', 'Odontologo creador de Plan:') !!}
  ...
  <div class="box-footer">
     <div class="form-horizontal" align="center">
          {!!Form::submit('Actualizar Plan de Tratamiento',['class'=>'btn btn-primary', 'id' => 'crear'])!!}
        </div>
  </div>
</div>
...
var pieza_dental;
var costo;
var costo_total = <?= $plan->pdt_costo_total?>;
var costos_tratamientos = <?php echo $costos_tratamientos?>;
var sumar_tratamiento = true;
